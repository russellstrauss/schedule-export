...
# Temporary workaround: Change package.json main to tests/test-function.js
...
$packageJson.main = "tests/test-function.js"
$packageJson | ConvertTo-Json -Depth 10 | Set-Content $packageJsonPath
Write-Host "Temporarily changed package.json main to tests/test-function.js for deployment" -ForegroundColor Gray
